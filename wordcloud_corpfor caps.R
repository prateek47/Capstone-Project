...
comparison.cloud(term.topic[,-4], max.words=100, 
...
comparison.cloud(term.topic2[, -4], max.words=100, 
                 scale=c(3, 1.5), random.order=FALSE, 
                 colors=c("blue3", "red3", "green3"), title.size=1)
...
comparison.cloud(comp.bio, max.words = 150,
...
comparison.cloud(comp.socialsc, max.words = 150,
                 scale = c(3, 1.5), random.order = F,
                 colors = c("blue3", "red3"), title.size = 1)
...
comparison.cloud(comp.phy, max.words = 150,
                 scale = c(3, 1.5), random.order = F,
                 colors = c("blue3", "red3"), title.size = 1)
